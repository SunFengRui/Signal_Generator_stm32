/*
** W5300 Register configuration:
**
** Besides W5300_MAP_ADDRESS ,all other registers use relative addresses!
*/
#define W5300_ADDRESS	0x60000000
...
/* IR register values */
#define IR_CONFLICT			0x8000 // check ip confict
#define IR_UNREACH			0x4000 // get the destination unreachable message in UDP sending
#define IR_PPPoE			0x2000 // get the PPPoE close message
#define IR_FMTU				0x1000
